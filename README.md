...
- [ ] M2 패널 UI — 중앙 팔레트(검색+리스트+프리뷰), 키보드 네비
- [ ] M3 붙여넣기 — 다이렉트 페이스트, plain 변환, ⌘1–9
- [ ] M4 깔롱 레이어 — 애니메이션, 스마트 카드, 테마, 하단 슬라이드 모드
- [ ] M5 파워 기능 — 핀보드, 변환 팔레트, 페이스트 스택, 제외 규칙
- [ ] M6 이주·마감 — Paste.db 임포트(178개), 로그인 시작, 설정
